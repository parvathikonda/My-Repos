...
my %conf = (
    ...
    RRD_HEARTBEAT      => 8640,
    RRA_STEP           => 60,
    RRA_CFG            => "/omd/versions/1.2.6p16.cre/etc/pnp4nagios/rra.cfg",
    STATS_DIR          => "/omd/versions/1.2.6p16.cre/var/pnp4nagios/stats",
    LOG_FILE           => "/omd/versions/1.2.6p16.cre/var/pnp4nagios/log/perfdata.log",
    ...
    KEY_FILE           => '/omd/versions/1.2.6p16.cre/etc/pnp4nagios/secret.key',
...
sub print_help {
  ...
  Options:
    ...
    Default: /omd/versions/1.2.6p16.cre/etc/pnp4nagios/process_perfdata.cfg
